...
Follow these steps if you wish to set up the project locally on your machine.
...
```bash
git clone https://github.com/Kushal-im-HIM/XORA-SaaS-App-Landing-Page.git
cd xora
```
...
> **IMPORTANT 👇**: The file should be named `index.jsx`, not `index.js`. This change is necessary because I've added SVG components in the constants file.
